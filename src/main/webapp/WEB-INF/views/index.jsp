   ...
   <div class="navbar-header">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li class="active"><a href="/medIS/">Home</a></li>
      ...
      <li><a href="/medIS/login">Log In</a></li>
      <li><a href="/medIS/admin">Register</a></li>
      </ul>
	...
	<div class="container" >
        <img src="<c:url value='/resources/img/healthcare.jpg'/>" alt="healthcare" width="80%" height="80%">
    </div>
